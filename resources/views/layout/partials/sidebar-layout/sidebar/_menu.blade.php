...
<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
	...
	<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
		...
		<div class="menu menu-column menu-rounded menu-sub-indention px-3 fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
			...
			<!--end:Menu item-->
				...
				<div class="menu-item">
				<!--begin:Menu link-->
				<a class="menu-link {{ request()->routeIs('profiles.*') ? 'active' : '' }}" href="{{ route('profiles.index') }}">
			...
			<!--end:Menu item-->
					...
					<div class="menu-item">
				<!--begin:Menu link-->
				<a class="menu-link {{ request()->routeIs('account-signups.*') ? 'active' : '' }}" href="{{ route('account-signups.index') }}">

					<span class="menu-icon">{!! getIcon('people', 'fs-2') !!}</span>
					<span class="menu-title">Account Signups</span>
				</a>
				<!--end:Menu link-->
			</div>
			<!--end:Menu item-->
	...
	<span class="menu-icon">{!! getIcon('people', 'fs-2') !!}</span>
			...
			<div class="menu-item">
								<!--begin:Menu link-->
	<a class="menu-link {{ request()->routeIs('ussd-sessions.*') ? 'active' : '' }}" href="{{ route('ussd-sessions.index') }}">
	<span class="menu-icon">{!! getIcon('people', 'fs-2') !!}</span>
					<span class="menu-title">Ussd Sessions</span>
				</a>
				<!--end:Menu link-->
				</div>
			<!--end:Menu item-->
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ request()->routeIs('dashboard') ? 'here show' : 'here' }}">
				...
				<span class="menu-link">
					<span class="menu-icon">{!! getIcon('chart-simple-3', 'fs-2') !!}</span>
				...
				<div class="menu-sub menu-sub-accordion">
						...
						<a class="menu-link {{ request()->routeIs('user-management.roles.*') ? 'active' : '' }}" href="{{ route('user-management.roles.index') }}">
							...
							<span class="menu-title">Requests Loan</span>
						</a>
						<!--end:Menu link-->
					</div>
					<!--end:Menu item-->
			...
			<div class="menu-item">
								<!--begin:Menu link-->
	<a class="menu-link {{ request()->routeIs('response-templates.*') ? 'active' : '' }}" href="{{ route('response-templates.index') }}">
	<span class="menu-icon">{!! getIcon('people', 'fs-2') !!}</span>
					<span class="menu-title">Response Templates</span>
				</a>
				<!--end:Menu link-->
				</div>
			<!--end:Menu item-->
