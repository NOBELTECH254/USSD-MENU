<x-dashboard-tile :position="$position" :refresh-interval="$refreshInterval">
        <a href="{{ route('payments.c-payments.index') }}" class="card bg-body hoverable card-xl-stretch mb-xl-8" style="background-color: #6C36DE;">
            <!--begin::Body-->
            <div class="card-body">
                <!--begin::Svg Icon | path: icons/duotune/general/gen032.svg-->
            <svg width="20" height="20" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 235.517 235.517" xml:space="preserve"
                fill="#000">
                ...
                <!--end::Svg Icon-->
                <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5" id="payments_today">
                    {{ number_format($data['thisMonthsTotalPayments']) }} KShs
                </div>

                <div class="fw-bold text-primary"> {{$data['month'] }} Totals</div>
            </div>
            <!--end::Body-->
        </a>
    </x-dashboard-tile>