<x-dashboard-tile :position="$position" :refresh-interval="$refreshInterval"  >
    <a href="{{ route('payments.c-payments.index') }}" class="card  hoverable card-xl-stretch mb-xl-8"  style="background-color: #171B2F;">
        <!--begin::Body-->
        <div class="card-body">
            ...
            <!--end::Svg Icon-->
            <div class=" fw-bolder fs-2 mb-2 mt-5" id ="totalAmountPaidToday">
                {{ number_format($data['totalAmountPaid']) }} KShs</div>
            <div class="fw-bold "> Today's Totals</div>
        </div>
        <!--end::Body-->
    </a>
</x-dashboard-tile>